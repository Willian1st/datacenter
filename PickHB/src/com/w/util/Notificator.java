...
public class Notificator {
	...
	public <T> void showNotification(String info, String content, Class<T> cls, int position) {
		try {
			Thread.sleep(1000);
		...
		// 定义属性
		Notification notification = new Notification(R.drawable.hb, info, System.currentTimeMillis());
