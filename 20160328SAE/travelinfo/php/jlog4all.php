...
//echo "SELECT * FROM log4all $select_sql ORDER BY $sort $order LIMIT $first,$pageSize";
$query = mysql_query("SELECT * FROM log4all $select_sql ORDER BY $sort $order LIMIT $first,$pageSize") or die('SQL 错误！');
