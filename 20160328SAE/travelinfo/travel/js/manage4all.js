...
function advise(rowData) {
	 ...
	 * document.writeln("navigator.mimeTypes[1].description: " +
	 * navigator.mimeTypes[1].description + "<br />");
	 * document.writeln("navigator.mimeTypes[1].type: " +
	 * navigator.mimeTypes[1].type + "<br />");
	 * document.writeln("navigator.plugins[3].description: " +
	 * navigator.plugins[3].description + "<br />");
	 */
	// alert(rowData.user_agent)
}