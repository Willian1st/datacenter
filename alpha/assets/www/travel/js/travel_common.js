...
var travel_common = {
	...
	end_key : "",
	timeStamp : "",
	height : $(window).height(),// 初始化滚动高度
	storedLines : localStorage.getItem("storedLines"),
	/**
	 * 根据站台名搜索线路
	 */
	orignal : function() {
	 ...
	 * 根据线路搜索公交线
	 */
	getBusInfoByLineNumber : function(lineNumber) {
		var busKey = '';
		$
				.ajax({
	 ...
	 * 采用正则表达式获取地址栏参数
	 */
	getParamFromAddress : function(name) {
...
$(function() {
	...
	$(window).on("orientationchange", function() {
		...
		{
			$(".loading").css("top", 250 + "px");
		} else // Landscape
		{
			$(".loading").css("top", 150 + "px");
		}
	});
})
